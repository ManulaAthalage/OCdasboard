...
const BpOcActionlComponent = () => {
  ...
  useEffect(() => {
    ...
    async function getData() {
      const response = await fetch("http://localhost:8082/bigpanda/oc?env=qa");
  ...
  return (
    <div className="col-md-6 col-lg-3 p-1">
      {alerts ? (
        <Card border="danger">
          <Card.Header>OC Action List</Card.Header>
          <Card.Body>
...
export default BpOcActionlComponent;
